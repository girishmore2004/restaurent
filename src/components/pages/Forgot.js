...
//       <h2 className="my-2" style={{ color: "aqua" }}>Change Password</h2>
...
//             required
//             style={{ backgroundColor: 'black', border: 'none', borderBottom: '3px solid white', color: 'white', marginTop: '20px', padding: '10px' }}
//           />
